    ...
    <div class="container">
        ...
        <form action="{{ route('clientes.update', $cliente->id) }}" method="POST">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="nombre_comercial" name="nombre_comercial" value="{{ $cliente->nombre_comercial }}" required>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input type="text" class="form-control" id="calle" name="calle" value="{{ $cliente->calle }}" required>
            </div>
            <div class="form-group">
                <label for="numero_exterior">Número Exterior</label>
                <input type="text" class="form-control" id="numero_exterior" name="numero_exterior" value="{{ $cliente->numero_exterior }}" required>
            </div>
            <div class="form-group">
                <label for="numero_interior">Número Interior</label>
                <input type="text" class="form-control" id="numero_interior" name="numero_interior" value="{{ $cliente->numero_interior }}">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <select class="form-control" id="estado" name="estado" required onchange="cargarMunicipios(this)">
                    ...
                    @foreach($estados as $estado)
                        <option value="{{ $estado->estado }}" @if($cliente->estado == $estado->estado) selected @endif>{{ $estado->estado }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="municipio" name="municipio" required>
                    ...
                    @foreach($municipios as $municipio)
                        <option value="{{ $municipio->municipio }}" @if($cliente->municipio == $municipio->municipio) selected @endif>{{ $municipio->municipio }}</option>
                    @endforeach
                </select>
            </div>
            <div class="form-group">
                ...
                <select class="form-control" id="regimen_fiscal_id" name="regimen_fiscal_id" required>
                    ...
                    @foreach($regimenesFiscales as $regimenFiscal)
                        <option value="{{ $regimenFiscal->id }}" @if($cliente->regimen_fiscal_id == $regimenFiscal->id) selected @endif>{{ $regimenFiscal->descripcion }}</option>
                    @endforeach
                </select>
            </div>
